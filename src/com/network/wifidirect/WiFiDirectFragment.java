...
public class WiFiDirectFragment extends Fragment implements ChannelListener,
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		manager = (WifiP2pManager) getActivity().getSystemService(
				Context.WIFI_P2P_SERVICE);
		channel = manager.initialize(getActivity(), getActivity()
				.getMainLooper(), null);
	...
	public void onChannelDisconnected() {
		...
		if (manager != null && !retryChannel) {
			Toast.makeText(getActivity(), "Channel lost. Trying again",
					Toast.LENGTH_LONG).show();
			resetData();
			retryChannel = true;
			manager.initialize(getActivity(), getActivity().getMainLooper(),
					this);
		} else {
			Toast.makeText(
					getActivity(),
